...
<div class="con_c">
    <div class="wrapper" ref="goodsWrapper">
        <div class="content">
            ...
            <div 
            class="content_c" 
            v-for="(item,index) in home_tiaowei"
...
export default {
    ...
    created(){
        this.handleHome_tiaoweiget(this.pageNum);
    },
    computed:{
        ...Vuex.mapState({
            home_tiaowei:state=>state.home.home_tiaowei
        })
    },
    methods:{
        ...Vuex.mapActions({
            handleHome_tiaoweiget:'home/handleHome_tiaoweiget',
        }),
        handleGo(val){
