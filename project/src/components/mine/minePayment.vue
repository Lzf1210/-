...
.payment{height:100%;width:100%;position: absolute;left:0;z-index: 2;background: #FCFCFC}
.payment>.title>h2{margin-left:40.5%;font-size:.34rem;font-family:PingFangSC-Regular}
.payment>.title{height:.88rem;width:100%;display: flex;padding:0 4.4%;align-items: center;border-bottom:2px solid #E1E1E1;background: #fff}
.payment>.content{height:100%;background: red}
.wrapper{
		overflow: hidden;
		position: absolute;
		top: 1.3rem;
