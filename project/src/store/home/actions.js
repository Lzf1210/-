...
export default {
    handleHome_fushiget({commit},params){
        ...
        axios({
            ...
            url:"/mp/goods/searchallgoods?&typeId=1&_page="+params+"&_limit=4",
        }).then((data)=>{
            // console.log(params)
                commit("handleHome_fushiget",data.data)
                // console.log(data.data)
    ...
    handleHome_xiaoshiget({commit},params){
        axios({
            ...
            url:"/mp/goods/searchgoodsbytypeid?&typeId=3&_page="+params+"&_limit=4",
        }).then((data)=>{
            // console.log(params)
    ...
    handleHome_guoshuget({commit},params){
        axios({
            ...
            url:"/mp/goods/searchgoodsbytypeid?&typeId=4&_page="+params+"&_limit=4",
        }).then((data)=>{
            // console.log(params)
    ...
    handleHome_goodsaget({commit},params){
        axios({
            ...
            url:"/mp/goods/searchgoodsbytypeid?&typeId=6&_page="+params+"&_limit=4",
        }).then((data)=>{
            // console.log(params)
